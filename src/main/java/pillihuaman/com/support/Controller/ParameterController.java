...
public class ParameterController {
    ...
    @PostMapping(path = {Constants.BASE_ENDPOINT + Constants.ENDPOINT + "/saveParameter"}, produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @GetMapping(path = {Constants.BASE_ENDPOINT + "/getParameterbyIdCode/idCode"}, produces = {MediaType.APPLICATION_JSON_VALUE})
