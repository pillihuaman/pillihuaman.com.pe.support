...
public class EmployeeController {
    ...
    @PostMapping(path = {Constants.BASE_ENDPOINT + Constants.ENDPOINT + "/employee"}, produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @GetMapping(path = {Constants.BASE_ENDPOINT + Constants.ENDPOINT + "/employee"}, produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @GetMapping(path = {Constants.BASE_ENDPOINT + "/employee/listEmployees"}, produces = {MediaType.APPLICATION_JSON_VALUE})
